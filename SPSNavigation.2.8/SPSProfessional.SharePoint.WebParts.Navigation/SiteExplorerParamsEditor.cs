...
{
    internal class SiteExplorerParamsEditor : EditorPart
    {
        ...
        public SiteExplorerParamsEditor()
        {
            ID = "SiteExplorerParamsEditor";
            Title = "SiteExplorer";
        }
        ...
        {
            EnsureChildControls();
            SiteExplorer webpart = WebPartToEdit as SiteExplorer;
