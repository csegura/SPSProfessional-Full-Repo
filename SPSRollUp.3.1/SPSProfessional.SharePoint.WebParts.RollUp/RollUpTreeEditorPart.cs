...
{
    internal class RollUpTreeEditorPart : RollUpEditorPartBase
    {
        ...
        public RollUpTreeEditorPart()
        {
            ID = "SPSRollUpTreeEditorPart";
            Title = "SPSTreeXML";
        }
        ...
        {
            EnsureChildControls();
            RollUpTree webpart = WebPartToEdit as RollUpTree;
        ...
        protected override void CreateChildControls()
        {
            ...
            _debugResultsXML.Text = SPSResources.GetString("SPSEP_DebugXMLTransformation");
        ...
        protected override void RenderContents(HtmlTextWriter writer)
        {
            ...
            partsTools.SectionHeaderTag(SPSResources.GetString("SPSEP_XMLTreeConfiguration"));
