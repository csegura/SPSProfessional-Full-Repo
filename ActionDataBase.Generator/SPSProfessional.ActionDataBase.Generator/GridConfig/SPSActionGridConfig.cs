...
namespace SPSProfessional.ActionDataBase.Generator.GridConfig
{
    ...
    public class SPSActionGridConfig
    {
        ...
        [XmlIgnore]
        [TypeConverter(typeof(ExpandableObjectConverter))]
        [DisplayName("4.- Grid Configuration")]
        public Grid Grid
        {
            get
            {
    ...
    public class Filter
    {
        ...
        {
            get { return ParamCollection[index]; }
        }
    ...
    public class Param
    {
        ...
        [XmlIgnore]
        //[TypeConverter(typeof(DefaultsTypeConverter))]
    ...
    public class Columns
    {
        ...
        {
            get { return  DataFieldCollection[index]; }
        }
    ...
    public class ContextMenu
    {
        ...
        {
            get { return ContextMenuItemCollection[index]; }
        }
