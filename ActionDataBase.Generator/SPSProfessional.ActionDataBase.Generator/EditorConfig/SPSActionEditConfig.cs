...
namespace SPSProfessional.ActionDataBase.Generator.EditorConfig
{
    ...
    public class SPSActionEditConfig
    {
        ...
        [XmlElement(Type=typeof (ActionToolBars), ElementName="ActionToolBars", IsNullable=false,
    ...
    public class Memo
    {
        ...
        [XmlIgnore]
        [TypeConverter(typeof(RichTextTypeConverter))]
